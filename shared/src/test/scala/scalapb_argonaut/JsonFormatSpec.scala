...
class JsonFormatSpec extends FlatSpec with MustMatchers with OptionValues {
  ...
  "DoubleFloatProto" should "parse NaNs" in {
    ...
    JsonFormat.toJson(out).obj.flatMap(_.apply("d")) must be (Some(Json.jString(Double.NaN.toString)))
    JsonFormat.toJson(out).obj.flatMap(_.apply("f")) must be (Some(Json.jString(Double.NaN.toString)))
  }
  ...
  "DoubleFloatProto" should "parse Infinity" in {
    ...
    JsonFormat.toJson(out).obj.flatMap(_.apply("d")) must be (Some(Json.jString(Double.PositiveInfinity.toString)))
    JsonFormat.toJson(out).obj.flatMap(_.apply("f")) must be (Some(Json.jString(Double.PositiveInfinity.toString)))
  }
  ...
  "DoubleFloatProto" should "parse -Infinity" in {
    ...
    JsonFormat.toJson(out).obj.flatMap(_.apply("d")) must be (Some(Json.jString(Double.NegativeInfinity.toString)))
    JsonFormat.toJson(out).obj.flatMap(_.apply("f")) must be (Some(Json.jString(Double.NegativeInfinity.toString)))
  }
